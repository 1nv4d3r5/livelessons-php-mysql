...
EOM;
    ...
    protected function generateBodyContents()
    {
        ...
        foreach ($users as $user)
        {
            ...
            if ($user->Userid == $me)
                $edit = "<a class='modify' href='ModifyUser.php?id={$user->Userid}'>[edit]</a>&nbsp;";
            else
                $edit = '&nbsp;';
    ...
    <div class='user_name'>
        <a title='View user photos ...' href='UserPhotos.php?uid={$user->Userid}'>$un</a>
    </div>
    <div class='full_name'>
        <a href='UserProfile.php?id={$user->Userid}'>[profile]</a>
        $fn $edit
    </div>
