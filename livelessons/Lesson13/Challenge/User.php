...
class User
{
    ...
    const USERLIST_NOSORT = 0;
    const USERLIST_SORTASC = 1;
    const USERLIST_SORTDESC = 2;
    ...
    public static function listUsers($start, $cusers, $alph = self::USERLIST_NOSORT)
    {
        $rows = UserData::fetch()->listUsers($start, $cusers, $alph);
        $output = array();
        foreach ($rows as $row)
        {
